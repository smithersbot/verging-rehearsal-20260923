...
- **Reports come back.** This page reached you through the same route every regression report uses (GET /v1/releases/run_20260923_db2258cda9d4/report), and your integration commits it the same way.
